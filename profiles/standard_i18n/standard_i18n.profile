...
function standard_i18n_profile_modules() {
  ...
  $contrib_packages = _standard_i18n_contrib_modules();
  ...
  $inst_mods = profile_download_files('standard_i18n', 'modules', array_keys($contrib_packages), $ignore, 6);
...
function standard_i18n_profile_details() {
  ...
  $contrib_modules = _standard_i18n_contrib_modules();
  $own_modules = _standard_i18n_own_modules();
  ...
  // Optional modules
  $optional_modules = _standard_i18n_optional_modules();
  ...
  // Optional themes.
  $optional_themes = _standard_i18n_optional_themes();
  $themes_list = '<ul>';
...
function standard_i18n_optional_modules_form(&$form_state, $url) {
  ...
  $form['optional_modules']['ipkg_modules'] = array(
    '#type' => 'checkboxes',
    '#title' => st('Optional modules'),
    '#options' => _standard_i18n_optional_modules(),
  );
...
function standard_i18n_optional_themes_form(&$form_state, $url) {
  ...
  $form['optional_themes']['ipkg_themes'] = array(
    '#type' => 'checkboxes',
    '#title' => st('Optional themes'),
    '#options' => _standard_i18n_optional_themes(),
  );
 ...
 */
function _standard_i18n_contrib_modules() {
  return array(
    // "Advanced help" is required by "Chaos tool suite".
    'advanced_help' => l('Advanced help', 'http://drupal.org/project/advanced_help', _standard_i18n_get_link_attr()),
    'cck' => l('Content Construction Kit (CCK)', 'http://drupal.org/project/cck', _standard_i18n_get_link_attr()),
    'ctools' => l('Chaos tool suite', 'http://drupal.org/project/ctools', _standard_i18n_get_link_attr()),
    'filefield' => l('FileField', 'http://drupal.org/project/filefield', _standard_i18n_get_link_attr()),
    'imageapi' => l('ImageAPI', 'http://drupal.org/project/imageapi', _standard_i18n_get_link_attr()),
    'imagecache' => l('ImageCache', 'http://drupal.org/project/imagecache', _standard_i18n_get_link_attr()),
    'imagefield' => l('ImageField', 'http://drupal.org/project/imagefield', _standard_i18n_get_link_attr()),
    'panels' => l('Panels', 'http://drupal.org/project/panels', _standard_i18n_get_link_attr()),
    'token' => l('Token', 'http://drupal.org/project/token', _standard_i18n_get_link_attr()),
    'views' => l('Views', 'http://drupal.org/project/views', _standard_i18n_get_link_attr()),

    'admin_language' => l('Admin Language', 'http://drupal.org/project/admin_language', _standard_i18n_get_link_attr()),
    'dul' => l('Disable User Language', 'http://drupal.org/project/dul', _standard_i18n_get_link_attr()),
    'i18n' => l('Internationalization', 'http://drupal.org/project/i18n', _standard_i18n_get_link_attr()),
    'language_sections' => l('Language Sections', 'http://drupal.org/project/language_sections', _standard_i18n_get_link_attr()),
    'languageicons' => l('Language Icons', 'http://drupal.org/project/languageicons', _standard_i18n_get_link_attr()),
    'languagelink_title' => l('Language Link Title', 'http://drupal.org/project/languagelink_title', _standard_i18n_get_link_attr()),
    'potx' => l('Translation template extractor', 'http://drupal.org/project/potx', _standard_i18n_get_link_attr()),
    'reglang' => l('Registration Language', 'http://drupal.org/project/reglang', _standard_i18n_get_link_attr()),
    'translation404' => l('Translation 404 – Translation Page Not Found', 'http://drupal.org/project/translation404', _standard_i18n_get_link_attr()),

    // Skinr is required from theme acquia_prosper.
    'skinr' => l('Skinr', 'http://drupal.org/project/skinr', _standard_i18n_get_link_attr()),
    // Transliteration is required from ImageCache and ImageCache UI.
    'transliteration' => l('Transliteration', 'http://drupal.org/project/transliteration', _standard_i18n_get_link_attr()),
  );
}
 ...
 */
function _standard_i18n_optional_modules() {
  return array(
    'content_profile' => l('Content Profile', 'http://drupal.org/project/content_profile', _standard_i18n_get_link_attr()),
    'logintoboggan' => l('LoginToboggan', 'http://drupal.org/project/logintoboggan', _standard_i18n_get_link_attr()),

    'simplenews' => l('Simplenews', 'http://drupal.org/project/simplenews', _standard_i18n_get_link_attr()),
    'simplenews_register' => l('Simplenews on register', 'http://drupal.org/project/simplenews_register', _standard_i18n_get_link_attr()),

    'bueditor' => l('BUEditor', 'http://drupal.org/project/bueditor', _standard_i18n_get_link_attr()),
    'imce' => l('IMCE', 'http://drupal.org/project/imce', _standard_i18n_get_link_attr()) .' '.'Recommended for BUEditor - insert images.',
    'imce_mkdir' => l('IMCE Mkdir', 'http://drupal.org/project/imce_mkdir', _standard_i18n_get_link_attr()),

    'pathauto' => l('Pathauto', 'http://drupal.org/project/pathauto', _standard_i18n_get_link_attr()),
    'views_bonus' => l('Views Bonus Pack', 'http://drupal.org/project/views_bonus', _standard_i18n_get_link_attr()),
    'fivestar' => l('Fivestar', 'http://drupal.org/project/fivestar', _standard_i18n_get_link_attr()),
    'votingapi' => l('Voting API', 'http://drupal.org/project/votingapi', _standard_i18n_get_link_attr()) .' '.'Needed by "Fivestar"!',
    'flatcomments' => l('Flatcomments', 'http://drupal.org/project/flatcomments', _standard_i18n_get_link_attr()),

    'node_expire' => l('Node Expire', 'http://drupal.org/project/node_expire', _standard_i18n_get_link_attr()),
    'rules' => l('Rules', 'http://drupal.org/project/rules', _standard_i18n_get_link_attr()) .' '.'Needed by "Node Expire"!',

    'acl' => l('ACL', 'http://drupal.org/project/acl', _standard_i18n_get_link_attr()) .' '.'Needed by "Forum Access" and optional by "Content Access"!',
    'content_access' => l('Content Access', 'http://drupal.org/project/content_access', _standard_i18n_get_link_attr()),
    'forum_access' => l('Forum Access', 'http://drupal.org/project/forum_access', _standard_i18n_get_link_attr()),
    'taxonomy_access' => l('Taxonomy Access Control', 'http://drupal.org/project/taxonomy_access', _standard_i18n_get_link_attr()),

    'coder' => l('Coder', 'http://drupal.org/project/coder', _standard_i18n_get_link_attr()),
    'devel' => l('Devel', 'http://drupal.org/project/develhttp://drupal.org/project/devel', _standard_i18n_get_link_attr()),
    'masquerade' => l('Masquerade', 'http://drupal.org/project/masquerade', _standard_i18n_get_link_attr()),
  );
}
 ...
 */
function _standard_i18n_own_modules() {
  return array(
    'explorer8_modus' => l('Explorer8 modus', 'http://www.quiptime.com/downloads', _standard_i18n_get_link_attr()) .' '.'(Quiptime Group module)',
  );
 ...
 */
function _standard_i18n_optional_themes() {
  return array(
    'a3_atlantis' => l('A3 Atlantis', 'http://drupal.org/project/a3_atlantis', _standard_i18n_get_link_attr()),
    'acquia_marina' => l('Acquia Marina', 'http://drupal.org/project/acquia_marina', _standard_i18n_get_link_attr()),
    'acquia_prosper' => l('Acquia Prosper', 'http://drupal.org/project/acquia_prosper', _standard_i18n_get_link_attr()),
    'acquia_slate' => l('Acquia Slate', 'http://drupal.org/project/acquia_slate', _standard_i18n_get_link_attr()),
    'fourseasons' => l('Four Seasons', 'http://drupal.org/project/fourseasons', _standard_i18n_get_link_attr()),
    'fusion' => l('Fusion', 'http://drupal.org/project/fusion', _standard_i18n_get_link_attr()) .' '.'Needed by "Acquia Prosper"!',
    'litejazz' => l('LiteJazz', 'http://demo.roopletheme.com/litejazz', _standard_i18n_get_link_attr()),
    'newsflash' => l('NewsFlash', 'http://demo.roopletheme.com/newsflash/', _standard_i18n_get_link_attr()),
    'radiant' => l('Radiant', 'http://drupal.org/project/radiant', _standard_i18n_get_link_attr()),
    'rootcandy' => l('RootCandy', 'http://drupal.org/project/rootcandy', _standard_i18n_get_link_attr()),
    'simply_modern' => l('Simply Modern', 'http://drupal.org/project/simply_modern', _standard_i18n_get_link_attr()),
    'zeropoint' => l('Zeropoint', 'http://drupal.org/project/zeropoint', _standard_i18n_get_link_attr()),
  );
}
 ...
 */
function _standard_i18n_get_link_attr() {
